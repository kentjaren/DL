...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataroot', default='/home/jaren/Frontal_ReID/data/Frontal_Profile_PRW', help='path to images (should have subfolder train and test)')
        ...
        self.parser.add_argument('--N_d', type=int, default=500, help='the sum of the identities')
