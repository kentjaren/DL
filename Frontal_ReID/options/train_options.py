...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--D_interval', type=int, default=5, help='the interval of each optimization of D')
        self.parser.add_argument('--w_L1', type=int, default=0.2, help='the weight of the L1 loss, [0, 1]')
